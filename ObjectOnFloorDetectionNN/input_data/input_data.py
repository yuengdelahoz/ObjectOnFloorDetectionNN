...
def readDataSets(npyFiles_path="/home/harry/Documents/Gits/YuengGit/ObjectOnFloorDetectionNN/Dataset/npyFiles"):
  ...
  trainImages, trainLabels = np.load(npyFiles_path + "/npyTrainingImages.npy"), np.load(npyFiles_path + "/npyTrainSuperPixels.npy")
  testImages, testLabels = np.load(npyFiles_path + "/npyTestingImages.npy"), np.load(npyFiles_path + "/npyTestSuperPixels.npy")
